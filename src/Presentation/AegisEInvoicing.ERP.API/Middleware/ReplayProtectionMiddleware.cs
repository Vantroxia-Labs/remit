...
/// Addresses lack of replay attack protection
...
public sealed class ReplayProtectionMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, IResponseIntegrityService integrityService)
    {
        ...
        var isEnabled = _configuration.GetValue<bool>("Security:ResponseIntegrity:EnableReplayProtection", true);
        ...
        try
        {
            ...
            var maxAgeMinutes = _configuration.GetValue<int>("Security:ResponseIntegrity:MaxTimestampAgeMinutes", 5);
    ...
    private bool IsCriticalEndpoint(HttpContext context)
    {
        ...
        // Only protect POST/PUT/DELETE/PATCH operations on critical endpoints
        if (method != "POST" 
        && method != "PUT" 
        && method != "PATCH" 
        && method != "DELETE")
        ...
        var criticalPaths = new[]
        {
            ...
            "/api/v1/firs/validatebulk",
            "/api/v1/firs/sign",
            "/api/v1/firs/signbulk",
            "/api/v1/firs/transmit",
            "/api/v1/firs/transmitbulk",
