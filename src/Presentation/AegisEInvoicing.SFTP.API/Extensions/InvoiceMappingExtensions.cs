...
namespace AegisEInvoicing.SFTP.API.Extensions
{
    public static class InvoiceMappingExtensions
    {
        ...
        public static CreateFIRSInvoiceCommand MapToCreateSFTPFIRSInvoiceCommand(this CreateInvoiceRequest request)
        {
            ...
            return new CreateFIRSInvoiceCommand
            {
                ...
                InvoiceSource = AegisEInvoicing.Domain.Enums.InvoiceSource.SFTP,
