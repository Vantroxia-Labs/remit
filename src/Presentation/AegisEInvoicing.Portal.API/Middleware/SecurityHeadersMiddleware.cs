    ...
    IConfiguration configuration)
{
    ...
    private void AddSecurityHeaders(HttpContext context)
    {
        ...
        headers.XContentTypeOptions = GetConfigValue("SecurityHeaders:XContentTypeOptions", "nosniff");
        ...
        headers.XFrameOptions = GetConfigValue("SecurityHeaders:XFrameOptions", "DENY");
        ...
        {
            headers.ContentSecurityPolicy = BuildProductionCsp();
