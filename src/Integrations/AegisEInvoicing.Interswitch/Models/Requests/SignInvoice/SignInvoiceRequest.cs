...
namespace AegisEInvoicing.Interswitch.Models.Requests.SignInvoice;

/// <summary>
/// Request to digitally sign a validated invoice
...
public class Item
{
    ...
    public string SellersItemIdentification { get; set; } = null!;
}
...
public sealed record SignInvoiceRequest
{
